...
class AppointmentForm(forms.ModelForm):
    DOCTORS_CHOICES = [
        ('kshitij.moghe_2026@woxsen.edu.in', 'Dr. Kshitij Moghe'),
        ('anay.samarth_2026@woxsen.edu.in', 'Dr. Anay Samarth'),
        ('harshit.chatterjee_2026@woxsen.edu.in', 'Dr. Harshit Chatterjee'),
    ]
